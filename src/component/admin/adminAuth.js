...
// auth, setAuth : verifier si utilisateur authentifier pour afficher formulaire d'ajout lot si non page d'authentification
// Les fonctions :
...
export default function AdminAuth() {
  ...
  const handleSubmit=async(e)=>{
    ...
    // console.log("verifier vous donner s'il vous plait")
    //window.alert("verifier vous donner s'il vous plait"); 
    setAlert(true)
    });
    }
